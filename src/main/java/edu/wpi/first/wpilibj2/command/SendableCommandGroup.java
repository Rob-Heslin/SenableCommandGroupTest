 ...
 * generated by the {@link iterateForward} and the 
 * {@link iterateBackward} methods.
 *
...
public class SendableCommandGroup extends CommandGroupBase {
  ...
  public void execute() {
    ...
    //save the index we last had, in case something outside chages it before execute is run again
    m_lastCommandIndexExecuted = currentCommandIndex;
  }
